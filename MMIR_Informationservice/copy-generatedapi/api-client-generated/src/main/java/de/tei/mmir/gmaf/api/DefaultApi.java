...
import de.tei.mmir.gmaf.invoker.*;
...
public class DefaultApi {
    ...
    public ApiResponse<List<MMFG>> getCollectionWithHttpInfo(String authToken) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<MMFG>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<GeneralMetadata>> getCollectionMetadataWithHttpInfo(String authToken) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<GeneralMetadata>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * </table>
     */
    public void getImage(String authToken, String id) throws ApiException {
        getImageWithHttpInfo(authToken, id);
    }
     ...
     * </table>
     */
    public ApiResponse<Void> getImageWithHttpInfo(String authToken, String id) throws ApiException {
    ...
    public ApiResponse<MMFG> getMMFGForIdWithHttpInfo(String authToken, String mmfgId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<MMFG>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<GMAF> getSessionWithHttpInfo(String session, String apiKey) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<GMAF>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
